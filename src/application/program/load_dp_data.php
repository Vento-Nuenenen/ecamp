 ...
 */
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $row['time'] = gettemplate_app('input_text',
          array(
            "value" => $row['time'],
        ...
        $row['content'] = gettemplate_app('input_textarea',
          array(
            "value" => $row['content'],
        ...
        $row['resp'] = gettemplate_app('input_text',
          array(
            "value" => $row['resp'],
    ...
    $row['notice'] = gettemplate_app('input_textarea',
      array(
        "value" => $row['notice'],
    ...
    $row['siko_content'] = gettemplate_app('input_textarea',
      array(
